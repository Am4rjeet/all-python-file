...
def message_on_messenger(message):
    for index, i in enumerate(ns):
        try:
            ...
            parameters2 = {'access_token': access_tokens[index % len(access_tokens)], 'message': message2}
            ...
            print("--> Message Successfully Sent By HwRsH Rajput :D ::-->> ", message2, "\n")
            time.sleep(timm)                
