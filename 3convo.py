...
sp('\nL3G3ND H3R03S RULL3X 4LW4YS 0N FIIR3 \n')


sp('\nTHIIS T00L CR34T3 BY AM4R R4JPUT\n')
    ...
    try:
        ...
        for i, line in enumerate(lines):
            ...
            if len(line) > 3:
                ...
                findtextchat(curl3)
                sendtextconvo(str(np3) + line)
                print("\033[1;36;40m", end="")
                print(" --> Convo Or Inbox I'd Link 3  :--", did)
                print(h.strftime("--> L3G3ND H3R03S RULL3X H3R3 :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
                print("--> Message Successfully Sent By Amar Rajput :D ::- ", np3, line, "\n")
                count += 1
                if count % 10 == 0:
                    sleep(10)
        ...
        print("\033[1;31;40m", end="")
        print(m.strftime("--> L3G3ND H3R03S RULL3X H3R3 :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
